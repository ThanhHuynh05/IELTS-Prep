...
export default function ReadingQuestions({ sections, allTestQuestions, userAnswers, onAnswerChange, onSubmit, hasPrevious, hasNext, onPrevious, onNext }) {
  ...
  return (
    <div className="flex flex-col flex-1 min-h-0 h-full pl-6 border-l border-gray-200 dark:border-gray-700">
